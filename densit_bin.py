...
outdir = '/export/durack1/git/Density_bining'
...
#            vmask = npy.nonzero(temp[t,:,j,i])
            ...
            if not vmask[0]: # check point is not masked
                ...
                c1_s[N_s] = x1_content[N_z-1,j,i] ; # Cell temperature/salinity
...
#                        print " z_zt[i_profil] ", z_zt[i_profil]
   ...
   #             print 'c1_s = ',c1_s
            ...
            vol_bin   [t,0:N_s,j,i] = thick_bin [t,0:N_s,j,i] * area[j,i] 
#* e1t * e2t
            x1_bin    [t,:,j,i]     = c1_s
            #bowl_bin  [j, i]        = bowl_s
...
vol_bin = mv.masked_where(x1_bin==valmask,vol_bin)
print depth_bin.dtype
print thick_bin.dtype
print vol_bin.dtype
