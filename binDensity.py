...
def densityBin(fileT,fileS,fileV,fileFx,outFile,debug=True,debugLev=2,timeint='all',mthout=False):
    ...
    - fileV(time,lev,lat,lon)   - 4D meridional verlocity array
    ...
    #regridObj = CdmsRegrid(ingrid,msk.outgrid,depthBini.dtype,missing=valmask,regridMethod='distwgt',regridTool='esmf')
    tintrp     = timc.clock()
    # testing
    ...
    for tc in range(tcmax):
        ...
        # Convert velocity into transport
...
#    return lev_thick,lev_thickt #TODO: remove!!
