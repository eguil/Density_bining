...
#        {'name':'bcc-csm1-1'    ,'props':[3,1,11,21], 'picontrol':[0],'correctFile':[0,0,0]}, # 3
#        {'name':'BNU-ESM'       ,'props':[1,0,11,156], 'picontrol':[559],'correctFile':[0,0,0]}, # 4
         {'name':'CanESM2'       ,'props':[5,5,11,156], 'picontrol':[996],'correctFile':[0,0,0]}, # 5
...
#        {'name':'CESM1-BGC'     ,'props':[1,0,11,156], 'picontrol':[500],'correctFile':[0,0,0]}, # 7
         {'name':'CESM1-CAM5'    ,'props':[3,2,11,156], 'picontrol':[319],'correctFile':[0,0,0]}, # 8
...
#        {'name':'CNRM-CM5-2'    ,'props':[1,0,11,156], 'picontrol':[410],'correctFile':[0,0,0]}, # 14
         ...
         {'name':'CSIRO-Mk3-6-0' ,'props':[9,5,11,156], 'picontrol':[500],'correctFile':[0,0,0]}, # 16
...
#        {'name':'GFDL-ESM2G'    ,'props':[1,0, 1,146], 'picontrol':[500],'correctFile':[0,0,0]}, # 23
         ...
         {'name':'GISS-E2-H'     ,'props':[14,11,11,156],'picontrol':[780],'correctFile':[0,0,0]},# 25
#        {'name':'GISS-E2-H-CC'  ,'props':[1,0,11,156], 'picontrol':[251],'correctFile':[0,0,0]}, # 26
         {'name':'GISS-E2-R'     ,'props':[16,11,11,156],'picontrol':[846],'correctFile':[0,0,0]},# 27
...
#        {'name':'HadGEM2-CC'    ,'props':[1,0, 1,146], 'picontrol':[240],'correctFile':[0,0,0]}, # 30
         {'name':'HadGEM2-ES'    ,'props':[3,3, 1,146], 'picontrol':[576],'correctFile':[0,0,0]}, # 31
...
#        {'name':'IPSL-CM5B-LR'  ,'props':[1,0,11,156], 'picontrol':[300],'correctFile':[0,0,0]}, # 34
         {'name':'MIROC-ESM-CHEM','props':[1,1,11,156], 'picontrol':[255],'correctFile':[0,0,0]}, # 35
         {'name':'MIROC-ESM'     ,'props':[3,3,11,156], 'picontrol':[100],'correctFile':[0,0,0]}, # 36
