...
#1        {'name':'CanESM2'       ,'props':[5,5,11,156], 'picontrol':[996]}, # 5
#1        {'name':'CCSM4'         ,'props':[6,4,11,156], 'picontrol':[1051]}, # 6
#        {'name':'CESM1-BGC'     ,'props':[1,0,11,156], 'picontrol':[500]}, # 7
#1        {'name':'CESM1-CAM5'    ,'props':[3,2,11,156], 'picontrol':[319]}, # 8
...
#1       {'name':'CNRM-CM5'      ,'props':[9,6,11,156], 'picontrol':[850]}, # 15
#1        {'name':'CSIRO-Mk3-6-0' ,'props':[9,5,11,156], 'picontrol':[500]}, # 16
#        {'name':'CSIRO-Mk3L-1-2','props':[2,0,10,155], 'picontrol':[0]}, # 17
#        {'name':'EC-EARTH'      ,'props':[6,0,11,156], 'picontrol':[452]}, # 18
#1        {'name':'FGOALS-g2'     ,'props':[4,3,11,156], 'picontrol':[700]}, # 19
#        {'name':'FGOALS-s2'     ,'props':[3,0,11,156], 'picontrol':[501]}, # 20
#        {'name':'GFDL-CM2p1'    ,'props':[9,0,11,156], 'picontrol':[0]}, # 21
#1        {'name':'GFDL-CM3'      ,'props':[4,3, 0,146], 'picontrol':[0]}, # 22
#        {'name':'GFDL-ESM2G'    ,'props':[1,0, 0,146], 'picontrol':[500]}, # 23
#1        {'name':'GFDL-ESM2M'    ,'props':[1,1, 0,146], 'picontrol':[500]}, # 24
#1        {'name':'GISS-E2-H'     ,'props':[14,11,11,156],'picontrol':[780]},# 25
#        {'name':'GISS-E2-H-CC'  ,'props':[1,0,11,156], 'picontrol':[251]}, # 26
#1        {'name':'GISS-E2-R'     ,'props':[16,11,11,156],'picontrol':[846]},# 27
...
#1        {'name':'HadGEM2-ES'    ,'props':[3,3, 1,146], 'picontrol':[576]}, # 31
#1        {'name':'IPSL-CM5A-LR'  ,'props':[6,3,11,156], 'picontrol':[1000]}, # 32
#1        {'name':'IPSL-CM5A-MR'  ,'props':[3,3,11,156], 'picontrol':[300]}, # 33
#        {'name':'IPSL-CM5B-LR'  ,'props':[1,0,11,156], 'picontrol':[300]}, # 34
#1        {'name':'MIROC-ESM-CHEM','props':[1,1,11,156], 'picontrol':[255]}, # 35
#1        {'name':'MIROC-ESM'     ,'props':[3,3,11,156], 'picontrol':[100]}, # 36
