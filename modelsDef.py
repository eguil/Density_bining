...
#
#  name, props=[Nb of hist members, nb of HistNat members, nb of 1pctCO2, idx of common interval [1861-2005]]
#      picontrol=[length of run], correctFile [idx_i,idx_i1,jmax] for longitude correction
#

    models = [
        {'name':'ACCESS1-0'     ,'props':[2,0,1,11,156], 'picontrol':[500],'correctFile':[0,0,0]}, # 0
        {'name':'ACCESS1-3'     ,'props':[3,0,1,11,156], 'picontrol':[500],'correctFile':[0,0,0]}, # 1
        {'name':'bcc-csm1-1-m'  ,'props':[3,0,0,11,156], 'picontrol':[0],'correctFile':[0,0,0]}, # 2
        {'name':'bcc-csm1-1'    ,'props':[3,1,0,11,156], 'picontrol':[0],'correctFile':[0,0,0]}, # 3
#        {'name':'bcc-csm1-1'    ,'props':[3,1,0,11,30], 'picontrol':[0],'correctFile':[0,0,0]}, # 3 testing shorter period
        {'name':'BNU-ESM'       ,'props':[1,0,1,11,156], 'picontrol':[559],'correctFile':[0,0,0]}, # 4
        {'name':'CanESM2'       ,'props':[5,5,0,11,156], 'picontrol':[996],'correctFile':[179,180,180]}, # 5
        {'name':'CCSM4'         ,'props':[6,4,1,11,156], 'picontrol':[1051],'correctFile':[139,140,145]}, # 6
        {'name':'CESM1-BGC'     ,'props':[1,0,1,11,156], 'picontrol':[500],'correctFile':[0,0,0]}, # 7
        {'name':'CESM1-CAM5'    ,'props':[3,2,1,11,156], 'picontrol':[319],'correctFile':[139,140,145]}, # 8
        {'name':'CESM1-FASTCHEM','props':[3,0,0,11,156], 'picontrol':[175],'correctFile':[0,0,0]}, # 9
        {'name':'CESM1-WACCM'   ,'props':[1,0,0,11,156], 'picontrol':[200],'correctFile':[0,0,0]}, # 10
        {'name':'CMCC-CESM'     ,'props':[1,0,0,11,156], 'picontrol':[277],'correctFile':[0,0,0]}, # 11
        ...
        {'name':'HadGEM2-ES'    ,'props':[3,3,1, 1,146], 'picontrol':[576],'correctFile':[179,179,180]}, # 31
        {'name':'IPSL-CM5A-LR'  ,'props':[6,3,1,11,156], 'picontrol':[1000],'correctFile':[0,0,0]}, # 32
        ...
        {'name':'NorESM1-ME'    ,'props':[1,0,0,11,156], 'picontrol':[0],'correctFile':[0,0,0]}, # 40
        {'name':'NorESM1-M'     ,'props':[2,0,0,11,156], 'picontrol':[0],'correctFile':[0,0,0]}, # 41
        ]
