...
#name = 'mme_1pctCO2vsPiC' # Regler le pb du slice : prendre autour de &) au lieu des 5 dernieres annees
#name = 'mme_1pctCO2'
#name = '1pctCO2'
...
#imodel = 0 # Choose model index in model list (modelsDef.py)
for imodel in range(1):
    ...
    if name == 'ens_mean_hist' or name == '1pctCO2' or name == 'ens_mean_hist_histNat':
    ...
    if name == 'Durack & Wijffels':
        ...
        if name == 'mme_hist_histNat' or name == 'mme_1pctCO2vsPiC' or name == 'ens_mean_hist_histNat':
