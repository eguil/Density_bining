...
"""
Python matplotlib
Make density projections of temperature and salinity change from the Durack&Wijfells data
...
if zonal_change == 'No':
    ...
    plt.suptitle('%s zonal asymmetry (map) and zonal mean of %s changes projected on isopycnals' %(name, legVar),
    ...
    plt.suptitle(
        '%s zonal basin asymmetry (map) and global zonal mean (plot) of %s changes projected on isopycnals' % (name, legVar),
        fontweight='bold', fontsize=13)
