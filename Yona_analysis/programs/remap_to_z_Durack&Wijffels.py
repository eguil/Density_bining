...
plt.figtext(.005,.58,'Pseudo-depth',rotation='vertical',fontweight='bold')
...
plotName = 'remapping_Durack&Wijffels_'+ v + 'changes_isopyccontours_5000'
...
#Not showing hatches when saving in PDF format
