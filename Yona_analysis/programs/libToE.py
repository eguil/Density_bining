...
def ToEdomainhistvshistNat(model_name, domain_name):
    ...
    if domain_name == 'Southern ST':
        ...
        domains = [
            ...
            {'name':'GISS-E2-R'     , 'Atlantic': [-35,-15,25.6,26.5],  'Pacific': [-25,-10,24,25.8],   'Indian': [-30,-15,25.4,26.1]}, # 9
...
def ToEdomain1pctCO2vsPiC(model_name, domain_name):
    ...
    if domain_name == 'Southern ST':
        ...
        domains = [
            ...
            {'name':'CCSM4'       , 'Atlantic': [-35,-15,25.2,25.8],  'Pacific': [-40,-15,24.8,26.2], 'Indian': [-37,-20,25.8,26.2]}, # 3
            {'name':'CESM1-BGC'   , 'Atlantic': [-45,-38,26.3,26.6],  'Pacific': [-40,-20,25.6,26.2], 'Indian': [-38,-20,25.8,26.3]}, # 4
            ...
            {'name':'CNRM-CM5-2'  , 'Atlantic': None,                 'Pacific': [-30,-15,25.2,26.2], 'Indian': [-35,-20,26,26.4]}, # 7
            {'name':'CSIRO-Mk3-6-0','Atlantic': [-20,-12,26,26.3],    'Pacific': [-20,-10,25,25.4],   'Indian': [-30,-25,26,26.3]}, # 8
            ...
            {'name':'GFDL-ESM2M'  , 'Atlantic': None,                 'Pacific': [-33,-20,25.8,26.3], 'Indian': [-35,-20,25.6,26.2]}, # 11
            {'name':'HadGEM2-ES'  , 'Atlantic': [-20,-10,25.8,26.6],  'Pacific': [-30,-20,25,25.8],   'Indian': [-30,-20,25.4,26]}, # 12
            {'name':'IPSL-CM5A-LR', 'Atlantic': [-43,-35,27.2,27.5],  'Pacific': [-25,-15,25.8,26.6], 'Indian': [-35,-20,26.5,26.9]}, # 13
            {'name':'IPSL-CM5A-MR', 'Atlantic': [-42,-35,27,27.2],    'Pacific': [-30,-15,25.4,26.4], 'Indian': [-35,-20,26.3,26.8]}, # 14
            {'name':'IPSL-CM5B-LR', 'Atlantic': [-45,-10,26,27],      'Pacific': [-40,-15,26,26.8],   'Indian': [-40,-20,26.2,26.8]} # 15
        ]
        domain_char = {'nb_basins': 3, 'Atlantic': True, 'Pacific': True, 'Indian': True}
    ...
    if domain_name == 'SO':
        ...
        # Southern Ocean (warmer/saltier in all three basins)
        domains = [
            {'name':'ACCESS1-0'   , 'Atlantic': [-55,-50,27,27.3],      'Pacific': [-60,-55,27,27.4],   'Indian': [-50,-45,26.6,26.8]}, # 0
            ...
            {'name':'CNRM-CM5'    , 'Atlantic': None,                   'Pacific': None,                'Indian': None}, # 6
            {'name':'CNRM-CM5-2'  , 'Atlantic': [-58,-53,27.7,27.8],    'Pacific': [-55,-45,26.6,27.2], 'Indian': [-52,-45,26.6,27.2]}, # 7
            ...
            {'name':'GFDL-ESM2M' ,  'Atlantic': [-55,-50,27.2,27.5],    'Pacific': [-70,-65,27.7,27.9], 'Indian': [-53,-45,27.2,27.5]}, # 11
            {'name':'HadGEM2-ES'  , 'Atlantic': [-55,-45,26.8,27.2],    'Pacific': [-55,-45,26.3,26.9], 'Indian': [-55,-45,26.6,27.2]}, # 12
            {'name':'IPSL-CM5A-LR', 'Atlantic': [-50,-40,27.7,27.9],    'Pacific': [-60,-55,27.7,27.9], 'Indian': None}, # 13
            {'name':'IPSL-CM5A-MR', 'Atlantic': [-53,-50,27.6,27.9],    'Pacific': [-60,-55,27.6,27.9], 'Indian': [-55,-45,27.8,27.9]}, # 14
            {'name':'IPSL-CM5B-LR', 'Atlantic': [-60,-50,27.8,28],      'Pacific': [-65,-60,27.8,27.9], 'Indian': [-60,-50,27.7,27.9]} # 15
        ]
    ...
    if domain_name == 'North Atlantic':
        ...
        # North Atlantic (warmer/saltier)
        domains = [
            {'name':'ACCESS1-0'   , 'Atlantic': [43,49,26.1,26.9], 'Pacific': None, 'Indian': None}, # 0
            {'name':'ACCESS1-3'   , 'Atlantic': [30,60,26,26.9], 'Pacific': None, 'Indian': None}, # 1
            ...
            {'name':'CNRM-CM5'    , 'Atlantic': None,          'Pacific': None, 'Indian': None}, # 6
            {'name':'CNRM-CM5-2'  , 'Atlantic': [30,45,26.5,27], 'Pacific': None, 'Indian': None}, # 7
            ...
            {'name':'HadGEM2-ES'  , 'Atlantic': [25,45,26,26.5], 'Pacific': None, 'Indian': None}, # 12
            {'name':'IPSL-CM5A-LR', 'Atlantic': [40,50,27,27.6], 'Pacific': None, 'Indian': None}, # 13
            {'name':'IPSL-CM5A-MR', 'Atlantic': [40,45,26.8,27.2], 'Pacific': None, 'Indian': None}, # 14
            {'name':'IPSL-CM5B-LR', 'Atlantic': [40,50,26,26.9], 'Pacific': None, 'Indian': None} # 15
        ]
    ...
    if domain_name == 'Northern ST':
        ...
        domains = [
            ...
            {'name':'ACCESS1-3'   , 'Pacific': [12,30,24.4,25.6],  'Indian': [22,25,25.8,26],   'Atlantic': None}, # 1
            {'name':'BNU-ESM'     , 'Pacific': [15,30,24.2,25.4],  'Indian': [15,25,26,26.8],   'Atlantic': None}, # 2
            {'name':'CCSM4'       , 'Pacific': [15,30,24.2,25.2],  'Indian': None,              'Atlantic': None}, # 3
            {'name':'CESM1-BGC'   , 'Pacific': [20,35,24.4,25.2],  'Indian': [22,25,25.4,26.3], 'Atlantic': None}, # 4
            {'name':'CESM1-CAM5'  , 'Pacific': None,               'Indian': None,              'Atlantic': None}, #5
            {'name':'CNRM-CM5'    , 'Pacific': None,               'Indian': None,              'Atlantic': None}, # 6
            {'name':'CNRM-CM5-2'  , 'Pacific': [15,32,24.6,25.8],  'Indian': [20,25,26,26.6],   'Atlantic': None}, # 7
            {'name':'CSIRO-Mk3-6-0','Pacific': [15,30,24,25],      'Indian': [15,25,26.2,26.9], 'Atlantic': None}, # 8
            ...
            {'name':'HadGEM2-ES'  , 'Pacific': [15,32,24.4,25.4],  'Indian': [15,25,25.6,26.5], 'Atlantic': None}, # 12
            {'name':'IPSL-CM5A-LR', 'Pacific': [15,35,24.8,26.2],  'Indian': [15,22,26.3,27],   'Atlantic': None}, # 13
            {'name':'IPSL-CM5A-MR', 'Pacific': [20,35,25,26],      'Indian': [15,20,25.8,26.7], 'Atlantic': None}, # 14
            {'name':'IPSL-CM5B-LR', 'Pacific': [10,30,25,26],      'Indian': [10,20,26.3,27],   'Atlantic': None} # 15
        ]
    ...
    if domain_name == 'North Pacific':
        ...
        domains = [
            ...
            {'name':'HadGEM2-ES'  , 'Pacific': [45,60,26.5,27], 'Atlantic': None, 'Indian': None}, # 12
            {'name':'IPSL-CM5A-LR', 'Pacific': [40,60,26.8,27.1], 'Atlantic': None, 'Indian': None}, # 13
            {'name':'IPSL-CM5A-MR', 'Pacific': [40,60,26.5,27], 'Atlantic': None, 'Indian': None}, # 14
            {'name':'IPSL-CM5B-LR', 'Pacific': [50,60,26.4,26.7], 'Atlantic': None, 'Indian': None} # 15
        ]
