...
#
# cnplot11 = zonal_2D(plt, 'var_2000_lat_hr', axes[0,0], axes[1,0], 'left', lat_hr, density, varAtl, minmax, domrho)
#
# cnplot11 = zonal_2D(plt, 'var_2000_lat_hr', axes[0,1], axes[1,1], 'mid', lat_hr, density, varPac, minmax, domrho)
#
# cnplot11 = zonal_2D(plt, 'var_2000_lat_hr', axes[0,2], axes[1,2], 'right', lat_hr, density, varInd, minmax, domrho)
#
#
# plt.subplots_adjust(hspace=.0001, wspace=0.05, left=0.04, right=0.86)
#
